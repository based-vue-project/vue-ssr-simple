...
Component.options.__file = "E:\\Front-end\\vue-SSR\\vue-ssr-1-self\\src\\component\\List.vue"
...
__webpack_require__(15)("2ad8fecc", content, false);
...
var _mutationTypes = __webpack_require__(49);
...
exports.default = {
	...
	computed: (0, _extends3.default)({}, (0, _vuex.mapGetters)(['list'])),
	methods: {
	...
	mounted: function mounted() {
		...
		_vue2.default.axios.get('http://localhost:3000/data').then(function (res) {
			var list = res.data.data.liveWodList;
			_this.$store.commit(_mutationTypes.LIST.GET_DATA, list);
		});
	}
}; //
//
